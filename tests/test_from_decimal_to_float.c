...
Suite *suite_from_decimal_to_float(void) {
  ...
  tcase_add_loop_test(tc1_1, from_decimal_to_float_3, 0, 100);
  tcase_add_loop_test(tc1_1, from_decimal_to_float_4, 0, 100);
  tcase_add_test(tc1_1, s21_from_decimal_to_float_1);
  tcase_add_loop_test(tc1_1, s21_from_decimal_to_float_2, 0, 100);
  tcase_add_loop_test(tc1_1, s21_from_decimal_to_float_3, 0, 100);
